...
Starting from raw transaction data with deliberately realistic messiness
(duplicate orders, missing values, inconsistent formatting), I validated
and cleaned the dataset in Python before running any analysis — see
[`Python/data_cleaning_eda.py`](Python/data_cleaning_eda.py) for the full
process. From there, SQL handled the segmentation and cohort analysis,
Excel built the KPI workbook, and Power BI's design translated both into
...
| Executive Summary | Sales Dashboard |
|---|---|
| ![Executive Summary](images/dashboard1_executive_summary.png) | ![Sales Dashboard](images/dashboard2_sales.png) |

| Customer Dashboard | Operations Dashboard |
|---|---|
| ![Customer Dashboard](images/dashboard3_customer.png) | ![Operations Dashboard](images/dashboard4_operations.png) |

## Excel Dashboard

| KPI Dashboard | Pivot Summary + Chart |
|---|---|
| ![Excel Dashboard](images/excel1_dashboard.png) | ![Pivot Summary](images/excel2_pivot_summary.png) |

| Monthly Trend (conditional formatting) | VLOOKUP / INDEX-MATCH Lookup Demo |
|---|---|
| ![Monthly Trend](images/excel3_monthly_trend.png) | ![Lookup Demo](images/excel4_lookup_demo.png) |

The working file (`Excel/northstar_dashboard.xlsx`) is in this repo — all
formulas are live, not hardcoded values.
...
*(Full list of 10 insights, 10 recommendations, 5 risks, and 5 opportunities in [`docs/business_insights.md`](docs/business_insights.md).)*
